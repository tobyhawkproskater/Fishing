...
def build_html(start: Optional[dt.date] = None) -> str:
    ...
    return (
        ...
        + "</section>"
        "<footer>"
        f"<div>{_h(w.name)} \u00b7 tide station Port Townsend (9444900)</div>"
        "<div>Score = tide \u00d7 wind \u00d7 precip \u00b7 GREEN = slack \u00b11h, wind &lt;10, gust &lt;20 "
        "\u00b7 PRIME = GREEN + glass-calm</div>"
        "<div>NOAA NWS \u00b7 NOAA CO-OPS \u00b7 NDBC \u00b7 Open-Meteo</div>"
        "</footer>"
        "</body></html>"
    )
